...
## Run Information
- Mayhem Run: mayhemheroes/l1vm/l1vm/52
- Git Commit: db7f1451e564523941f283a5b8da011b7782fd40
- Original Image: ghcr.io/mayhemheroes/l1vm:master
- Target Executable: /l1vm-nojit
- CI URL: https://github.com:443/mayhemheroes/l1vm//actions/runs/3812653795
...
RUN cp <build-artifact> /l1vm-nojit
...
- `COPY . /rlenv/source/l1vm/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/l1vm/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /l1vm-nojit`
...
- [ ] Target executable in Dockerfile.rlenv: `/l1vm-nojit`
- [ ] Target executable in build.sh: `/l1vm-nojit`
- [ ] Target executable in metadata.json: `/l1vm-nojit`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/l1vm/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/l1vm/fuzz
...
- Source copy: `COPY . /rlenv/source/l1vm/`
...
- Working directory: `cd /rlenv/source/l1vm/`
- No network access
